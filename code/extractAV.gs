function extractAV(cvss3) {
  ...
  if (match) {
    ...
    if (extractedString === 'N') {
        translatedValue = 'Network';
      } else if (extractedString === 'L') {
        translatedValue = 'Local';
      } else if (extractedString === 'P') {
        translatedValue = 'Physical';
      }else if (extractedString === 'A') {
        translatedValue = 'Adjacent';
      } else {
